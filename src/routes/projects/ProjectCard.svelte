...
<div class="flex flex-col rounded border-2 border-lines p-2">
  <a href={url} class="text-secondary-blue hover:underline flex items-center">
    {title}
    <svg class="w-4 h-4 mx-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
